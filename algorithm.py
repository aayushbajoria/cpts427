''''
Aayush Bajoria
CPT_S 427 - Steganogrpahy Project
''''
# External Libraries 
import cv2
import struct
...
import data_embedding as stego
 ...
 #-- this will be implemented when adding image and converting 

NUM_CHANNELS = 3
COVER_IMAGE_FILEPATH  = "./your_carrier_image.png" 
STEGO_IMAGE_FILEPATH  = "./steg_image.png"
SECRET_MESSAGE_STRING = "Input your message here"

raw_cover_image = cv2.imread(COVER_IMAGE_FILEPATH, flags=cv2.IMREAD_COLOR)
height, width   = raw_cover_image.shape[:2]

#we are limiting image to be 8x8 
